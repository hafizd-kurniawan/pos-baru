class ApiEndpoints {
  ...
  static String resetPassword(int userId) => '/api/users/$userId/reset-password';
  ...
  static String purchaseTransactionById(int id) => '/api/transactions/purchase/$id';
  static String salesTransactionById(int id) => '/api/transactions/sales/$id';
  static String updatePurchasePayment(int id) => '/api/transactions/purchase/$id/payment';
  static String updateSalesPayment(int id) => '/api/transactions/sales/$id/payment';
  ...
  static String checkSparePartStock(int id) => '/api/spare-parts/$id/stock-check';
  ...
  static String removeRepairSparePart(int id, int sparePartId) => '/api/repairs/$id/spare-parts/$sparePartId';
